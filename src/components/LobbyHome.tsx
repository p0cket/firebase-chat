...

{
  /* <>
{isLoading && <Loading />}
{!isLoading && !currentLobby && (
  // Render the create room component if no lobby is found
  <WaitingRoom
    currentLobby={null} // Pass null to indicate no lobby
    errorMessage={errorMessage}
  />
)}
{currentLobby === null && !isLoading && (
  <CreateRoom
    errorMessage={errorMessage}
    lobbyCode={lobbyCode}
    setLobbyCode={setLobbyCode}
